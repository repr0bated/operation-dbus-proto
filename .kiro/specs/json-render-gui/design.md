...
The LLM generates specs that bind to this structure. Uses slash tip notation for simple bindings:
...
```json
{
  ...
  "elements": {
    ...
    "pagination": {
      "type": "Row",
      "visible": "/$state.children.next_cursor",
      ...
      "on": {
        "click": {
          ...
          "payload": {
            ...
            "args": {
              "cursor": "/$state.children.next_cursor"
            }
          }
        }
      }
