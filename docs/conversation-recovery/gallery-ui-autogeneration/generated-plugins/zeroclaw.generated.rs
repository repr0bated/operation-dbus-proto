...
mod inspector_gadget_generated {
    ...
    pub struct InspectorGadgetFields {
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.enum_field@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.public_base_url@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.exposed_skills@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.agent_alias@v1"))]
        pub agent_alias: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.AgentCostStats.cached_input_tokens`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.cached_input_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.cost_usd@v1"))]
        pub cost_usd: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.AgentCostStats.input_tokens`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.input_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.output_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.request_count@v1"))]
        pub request_count: Option<u64>,

        /// Discovered from Repomix path `struct.zeroclaw_config.AgentCostStats.total_tokens`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.total_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.personality_file@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.personality_files@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.system_prompt@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.read_memory_from@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.unrestricted_filesystem@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.channel_type@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.approver_channel@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.on_no_approver@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.timeout_secs@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.complex_hint@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.cost_optimized_hint@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.simple_hint@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.standard_hint@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allowed_domains@v1"))]
        pub allowed_domains: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.BrowserDelegateConfig.blocked_domains`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.blocked_domains@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.chrome_profile_dir@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.limit_usd@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.model_provider@v1"))]
        pub model_provider: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.BuilderSubmission.peer_groups`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.peer_groups@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.risk_profile@v1"))]
        pub risk_profile: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.BuilderSubmission.runtime_profile`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.runtime_profile@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.deleted_entry@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allowed_destinations@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.connection_id@v1"))]
        pub connection_id: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.ClawdTalkConfig.excluded_tools`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.excluded_tools@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.from_number@v1"))]
        pub from_number: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.ClawdTalkConfig.webhook_secret`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.webhook_secret@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.op_index@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.alias_source@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.enum_variants@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.is_env_overridden@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.is_secret@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.type_hint@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.identifier_policy@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_passes@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.protect_first_n@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.protect_last_n@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.source_max_chars@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.summary_max_chars@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.summary_model@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.summary_provider@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.threshold_ratio@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.tool_result_retrim_chars@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.tool_result_trim_exempt@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.session_id@v1"))]
        pub session_id: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.CostRecord.task_id`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.task_id@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.aggregates_current@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.cached_day@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.cached_month@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.cached_year@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.daily_cost_usd@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.monthly_cost_usd@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.by_agent@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.by_model@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.session_cost_usd@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.total_cost@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.session_totals@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.default_subject@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_attachment_bytes@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.observer_mode@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.poll_interval_secs@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.client_id@v1"))]
        pub client_id: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.EmailOAuth2Config.device_code_url`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.device_code_url@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.token_url@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_retries@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.min_quality_score@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.suite_dir@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.last_attempt@v1"))]
        pub last_attempt: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.FailedAttemptState.lockout_until`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.lockout_until@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.backup_dir@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.entries_relocated@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.encrypt_secrets@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.secret_store_dir@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.label_filter@v1"))]
        pub label_filter: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.GmailPushConfig.oauth_token`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.oauth_token@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.webhook_url@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.collapse_tool_results@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.keep_recent@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.owned_state@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.target_alias@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.target_kind@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.display_name@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.natural_key@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.resource_key@v1"))]
        pub resource_key: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.MapKeySection.value_type`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.value_type@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.backup_path@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.to_version@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.provider_type@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.failed_attempts@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.paired_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.pairing_code@v1"))]
        pub pairing_code: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.PairingGuard.require_pairing`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.require_pairing@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.admin_for_agent_scope@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.external_peers@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.output_modality@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.credential_class@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.derived_from_secret@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.display_value@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.raw_value@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.dirty_paths@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.new_alias@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.old_alias@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.dropped_security@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.preset_name@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.is_set@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.key_path@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allowed_commands@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allowed_roots@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allowed_roots_read_only@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allowed_roots_write_only@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allowed_tools@v1"))]
        pub allowed_tools: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.SecurityPolicy.always_ask`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.always_ask@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.auto_approve@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.block_high_risk_commands@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.firejail_args@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.forbidden_paths@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_actions_per_hour@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_cost_per_day_cents@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.require_approval_for_medium_risk@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.risk_profile_name@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.shell_timeout_secs@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.workspace_dir@v1"))]
        pub workspace_dir: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.SecurityPolicy.workspace_only`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.workspace_only@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.budget_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.default_level@v1"))]
        pub default_level: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.ThinkingConfig.native_thinking`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.native_thinking@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.pricing_available@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.local_whisper@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.correction_penalty@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.decay_half_life_days@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.initial_score@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.regression_threshold@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.success_boost@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.embedding_routes@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.extra_headers@v1"))]
        pub extra_headers: Option<String>,

        /// Discovered from Repomix path `struct.zeroclaw_config.V1Config.model_providers`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.model_providers@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.provider_max_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.provider_timeout_secs@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.schema_version@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.inner_name@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.require_outbound_approval@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.transcription_logging@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allow_public_bind@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.archive_after_days@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.auto_save@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.embedding_provider@v1"))]
        pub embedding_provider: Option<String>,

        /// Discovered from Repomix path `toml.dev.config.harness-test.memory.hygiene_enabled`. Review before promotion.
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.hygiene_enabled@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.purge_after_days@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.risk_profiles@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.runtime_profiles@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.context_compression@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_context_tokens@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_tool_iterations@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.max_tool_result_chars@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.allow_override@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.daily_limit_usd@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.monthly_limit_usd@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.warn_at_percent@v1"))]
        ...
        #[serde(default)]
        #[schemars(extend("x-oscal-subid" = "obs.software.zeroclaw.web_dist_dir@v1"))]
    ...
    pub const METHOD_CANDIDATES: &[MethodCandidate] = &[
        MethodCandidate {
            ...
            subid: "mut.software.zeroclaw.agents_create@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.agents_delete@v1",
        ...
        MethodCandidate {
            ...
            subid: "obs.software.zeroclaw.agents_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.agents_rename@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_emaillogin@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.auth_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_login@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_logout@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_pasteredirect@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_pastetoken@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_refresh@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_setuptoken@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.auth_use@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channel_add@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channel_bindtelegram@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channel_doctor@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.channel_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channel_remove@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channel_send@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channel_start@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channels_create@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channels_delete@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.channels_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.channels_rename@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.config_complete@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.config_docs@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.config_generate@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.config_get@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.config_init@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.config_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.config_migrate@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.config_patch@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.config_set@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_add@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_addat@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_addevery@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.cron_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_once@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_pause@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_remove@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_resume@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.cron_update@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.deprecatedprops_any@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.doctor_models@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.doctor_traces@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.doctor_updatecontextwindows@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.eval_run@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.gateway_getpaircode@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.gateway_restart@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.gateway_start@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.hardware_discover@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.hardware_info@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.hardware_introspect@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.integration_info@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.memory_clear@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.memory_get@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.memory_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.memory_reindex@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.memory_stats@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.migrate_openclaw@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.model_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.model_refresh@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.peripheral_add@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.peripheral_flash@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.peripheral_flashnucleo@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.peripheral_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.peripheral_setupunoq@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.plugin_info@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.plugin_install@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.plugin_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.plugin_migrate@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.plugin_remove@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.plugin_search@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.providers_create@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.providers_delete@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.providers_rename@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.service_install@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.service_logs@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.service_restart@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.service_start@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.service_stop@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.service_uninstall@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skillbundle_add@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.skillbundle_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skillbundle_remove@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skillbundle_rename@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.skillbundle_show@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skill_add@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skill_audit@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skill_bundle@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skill_edit@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skill_install@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.skill_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skill_remove@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.skill_test@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.sop_approve@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.sop_delete@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.sop_deny@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.sop_graph@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.sop_list@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.sop_pending@v1",
        ...
        MethodCandidate {
            ...
            idempotent: true,
            required_capability: "zeroclaw.read",
            subid: "obs.software.zeroclaw.sop_show@v1",
        ...
        MethodCandidate {
            ...
            idempotent: false,
            required_capability: "zeroclaw.write",
            subid: "mut.software.zeroclaw.sop_validate@v1",
