...
export function grpcServerStream(
  ...
  // Route chat service to chatbot's own network identity (10.50.0.1)
  const isChatService = service === "op_chat.chat.ChatService";
  const base = isChatService ? "http://10.50.0.1:50053" : getBaseUrl();
