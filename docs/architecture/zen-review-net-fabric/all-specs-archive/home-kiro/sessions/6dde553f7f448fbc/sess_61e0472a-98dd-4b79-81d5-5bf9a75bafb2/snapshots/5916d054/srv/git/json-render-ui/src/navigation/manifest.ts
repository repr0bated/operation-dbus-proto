...
export const NAV_MANIFEST: NavManifestItem[] = [
  ...
  { id: "adc", label: "ADC", route: "/adc", icon: "circuit", section: "Control", order: 5 },
  { id: "agent-config", label: "Agent Config", route: "/agent-config", icon: "settings", section: "Control", order: 6 },
