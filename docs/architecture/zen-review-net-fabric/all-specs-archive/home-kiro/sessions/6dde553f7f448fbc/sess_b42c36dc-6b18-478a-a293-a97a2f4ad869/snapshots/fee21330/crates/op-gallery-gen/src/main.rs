...
use op_gallery_gen::{
    admission::GalleryAdmission, context::GenerationContext, inference::InferenceLoop,
    validator::SpecValidator, GalleryGenConfig,
};
...
async fn run_generation(
    ...
    tracing::info!(
        "Generation complete: {} specs generated in {} attempts",
        generated,
        attempts
    );
    Ok(())
