...
pub struct SchemaRendererState {
    ...
    /// Uncapped fields discovered from json-render schema and validation sources.
    #[serde(default)]
    #[schemars(extend("x-oscal-subid" = "sch.software.plugin.schema-renderer.inspector-fields@v1"))]
...
pub(crate) fn schema_renderer_schema() -> PluginSchema {
    ...
    schema.capabilities.insert(
        ...
        CapabilityDecl {
            ...
            description: "Grants: render_schema, list_galleries, get_rendering, validate_schema.".to_string(),
        },
    );
