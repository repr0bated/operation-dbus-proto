...
pub struct WorkflowsState { pub status: String, pub workflows: Value, pub config: Value }
pub struct WorkflowsPlugin;
impl Default for WorkflowsPlugin { fn default() -> Self { Self } }
...
impl StatePlugin for WorkflowsPlugin {
    ...
    fn schema(&self) -> Option<PluginSchema> { Some(super::plugin_schema_defs::workflows_plugin_schema()) }
