//! TchedRouter D-Bus + gRPC object blob prototype.
//!
...
/// Immutable bridge-local identity for the TchedRouter object projection.
///
...
/// Build the immutable object blob from the plugin-owned TchedRouter schema.
