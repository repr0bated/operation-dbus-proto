...
pub use schema_bridge::{
    ...
    verify_ghostbridge_footprint, watch_wireguard_handshakes, write_schema_blob, write_sled,
    write_sled_from_wg, write_sled_full, FootprintVerifyError, IdentitySled, SocketEntry,
    SubidCategory, SubidTaxonomy, SHM_SLED_PATH, SHM_XRAY_CONFIG,
};
