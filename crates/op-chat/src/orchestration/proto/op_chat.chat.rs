...
pub mod chat_service_server {
    ...
    pub trait ChatService: std::marker::Send + std::marker::Sync + 'static {
        ...
        type SendStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::ChatFrame, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /// Stream a chat completion. Returns a stream of ChatFrame events.
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/op_chat.chat.ChatService/Send" => {
                    ...
                    struct SendSvc<T: ChatService>(pub Arc<T>);
                    impl<
                        T: ChatService,
                    > tonic::server::ServerStreamingService<super::SendRequest>
                    for SendSvc<T> {
                        type Response = super::ChatFrame;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ChatService>::send(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/op_chat.chat.ChatService/Approve" => {
                    #[allow(non_camel_case_types)]
                    struct ApproveSvc<T: ChatService>(pub Arc<T>);
                    impl<
                        T: ChatService,
                    ...
                    for ApproveSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ChatService>::approve(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/op_chat.chat.ChatService/Cancel" => {
                    #[allow(non_camel_case_types)]
                    struct CancelSvc<T: ChatService>(pub Arc<T>);
                    impl<
                        T: ChatService,
                    ...
                    for CancelSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ChatService>::cancel(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "op_chat.chat.ChatService";
