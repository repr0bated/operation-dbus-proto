...
impl AgentStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unknown => "AGENT_STATUS_UNKNOWN",
            Self::Starting => "AGENT_STATUS_STARTING",
            Self::Running => "AGENT_STATUS_RUNNING",
            Self::Busy => "AGENT_STATUS_BUSY",
            Self::Stopping => "AGENT_STATUS_STOPPING",
            Self::Stopped => "AGENT_STATUS_STOPPED",
            Self::Error => "AGENT_STATUS_ERROR",
            Self::Unresponsive => "AGENT_STATUS_UNRESPONSIVE",
        }
    }
...
impl ChunkType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unknown => "CHUNK_TYPE_UNKNOWN",
            Self::Stdout => "CHUNK_TYPE_STDOUT",
            Self::Stderr => "CHUNK_TYPE_STDERR",
            Self::Progress => "CHUNK_TYPE_PROGRESS",
            Self::Result => "CHUNK_TYPE_RESULT",
            Self::Heartbeat => "CHUNK_TYPE_HEARTBEAT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ThinkingStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Default => "THINKING_STYLE_DEFAULT",
            Self::Analytical => "THINKING_STYLE_ANALYTICAL",
            Self::Creative => "THINKING_STYLE_CREATIVE",
            Self::Critical => "THINKING_STYLE_CRITICAL",
            Self::Systematic => "THINKING_STYLE_SYSTEMATIC",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ThoughtType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Observation => "THOUGHT_TYPE_OBSERVATION",
            Self::Hypothesis => "THOUGHT_TYPE_HYPOTHESIS",
            Self::Analysis => "THOUGHT_TYPE_ANALYSIS",
            Self::Conclusion => "THOUGHT_TYPE_CONCLUSION",
            Self::Question => "THOUGHT_TYPE_QUESTION",
            Self::Reflection => "THOUGHT_TYPE_REFLECTION",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ChainStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unknown => "CHAIN_STATUS_UNKNOWN",
            Self::Thinking => "CHAIN_STATUS_THINKING",
            Self::Analyzing => "CHAIN_STATUS_ANALYZING",
            Self::Concluding => "CHAIN_STATUS_CONCLUDING",
            Self::Complete => "CHAIN_STATUS_COMPLETE",
            Self::Stuck => "CHAIN_STATUS_STUCK",
            Self::Error => "CHAIN_STATUS_ERROR",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ContextType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Generic => "CONTEXT_TYPE_GENERIC",
            Self::Project => "CONTEXT_TYPE_PROJECT",
            Self::Conversation => "CONTEXT_TYPE_CONVERSATION",
            Self::Task => "CONTEXT_TYPE_TASK",
            Self::Knowledge => "CONTEXT_TYPE_KNOWLEDGE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl MergeStrategy {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Concat => "MERGE_STRATEGY_CONCAT",
            Self::Dedupe => "MERGE_STRATEGY_DEDUPE",
            Self::Latest => "MERGE_STRATEGY_LATEST",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl OutputStreamType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::OutputStreamStdout => "OUTPUT_STREAM_STDOUT",
            Self::OutputStreamStderr => "OUTPUT_STREAM_STDERR",
            Self::OutputStreamCompiler => "OUTPUT_STREAM_COMPILER",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl AnalysisType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Dependencies => "ANALYSIS_TYPE_DEPENDENCIES",
            Self::Structure => "ANALYSIS_TYPE_STRUCTURE",
            Self::Complexity => "ANALYSIS_TYPE_COMPLEXITY",
            Self::Unused => "ANALYSIS_TYPE_UNUSED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl DesignStyle {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Minimal => "DESIGN_STYLE_MINIMAL",
            Self::Comprehensive => "DESIGN_STYLE_COMPREHENSIVE",
            Self::Iterative => "DESIGN_STYLE_ITERATIVE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl DocumentFormat {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Markdown => "DOCUMENT_FORMAT_MARKDOWN",
            Self::Html => "DOCUMENT_FORMAT_HTML",
            Self::Asciidoc => "DOCUMENT_FORMAT_ASCIIDOC",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl WorkstackEventType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::WorkstackEventStarted => "WORKSTACK_EVENT_STARTED",
            Self::WorkstackEventPhaseStarted => "WORKSTACK_EVENT_PHASE_STARTED",
            Self::WorkstackEventPhaseProgress => "WORKSTACK_EVENT_PHASE_PROGRESS",
            Self::WorkstackEventPhaseCompleted => "WORKSTACK_EVENT_PHASE_COMPLETED",
            Self::WorkstackEventPhaseFailed => "WORKSTACK_EVENT_PHASE_FAILED",
            Self::WorkstackEventPhaseSkipped => "WORKSTACK_EVENT_PHASE_SKIPPED",
            Self::WorkstackEventCompleted => "WORKSTACK_EVENT_COMPLETED",
            Self::WorkstackEventFailed => "WORKSTACK_EVENT_FAILED",
            Self::WorkstackEventRollbackStarted => "WORKSTACK_EVENT_ROLLBACK_STARTED",
            Self::WorkstackEventRollbackCompleted => "WORKSTACK_EVENT_ROLLBACK_COMPLETED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl WorkstackExecutionStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::WorkstackExecutionPending => "WORKSTACK_EXECUTION_PENDING",
            Self::WorkstackExecutionRunning => "WORKSTACK_EXECUTION_RUNNING",
            Self::WorkstackExecutionCompleted => "WORKSTACK_EXECUTION_COMPLETED",
            Self::WorkstackExecutionFailed => "WORKSTACK_EXECUTION_FAILED",
            Self::WorkstackExecutionCancelled => "WORKSTACK_EXECUTION_CANCELLED",
            Self::WorkstackExecutionRollingBack => "WORKSTACK_EXECUTION_ROLLING_BACK",
            Self::WorkstackExecutionRolledBack => "WORKSTACK_EXECUTION_ROLLED_BACK",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod agent_lifecycle_server {
    ...
    #[async_trait]
    pub trait AgentLifecycle: std::marker::Send + std::marker::Sync + 'static {
        /// Start a session and run-on-connection agents
    ...
    /// Manages agent lifecycle (start/stop/health)
    #[derive(Debug)]
    pub struct AgentLifecycleServer<T> {
        inner: Arc<T>,
    ...
    impl<T> Clone for AgentLifecycleServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "op_chat.orchestration.AgentLifecycle";
    impl<T> tonic::server::NamedService for AgentLifecycleServer<T> {
...
pub mod agent_execution_server {
    ...
    #[async_trait]
    pub trait AgentExecution: std::marker::Send + std::marker::Sync + 'static {
        /// Execute a single operation
        async fn execute(
            &self,
    ...
    /// Execute operations on agents
    #[derive(Debug)]
    pub struct AgentExecutionServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> Clone for AgentExecutionServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "op_chat.orchestration.AgentExecution";
    impl<T> tonic::server::NamedService for AgentExecutionServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod memory_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "op_chat.orchestration.MemoryService";
...
pub mod sequential_thinking_service_server {
    ...
    #[async_trait]
    pub trait SequentialThinkingService: std::marker::Send + std::marker::Sync + 'static {
        /// Start a thinking chain
    ...
    #[derive(Debug)]
    pub struct SequentialThinkingServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SequentialThinkingServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for SequentialThinkingServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "op_chat.orchestration.SequentialThinkingService";
    impl<T> tonic::server::NamedService for SequentialThinkingServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod context_manager_service_server {
    ...
    #[async_trait]
    pub trait ContextManagerService: std::marker::Send + std::marker::Sync + 'static {
        async fn save(
            &self,
    ...
    #[derive(Debug)]
    pub struct ContextManagerServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> ContextManagerServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for ContextManagerServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "op_chat.orchestration.ContextManagerService";
    impl<T> tonic::server::NamedService for ContextManagerServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod rust_pro_service_server {
    ...
    #[async_trait]
    pub trait RustProService: std::marker::Send + std::marker::Sync + 'static {
        /// Quick operations (non-streaming)
        async fn check(
            &self,
    ...
    #[derive(Debug)]
    pub struct RustProServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> Clone for RustProServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "op_chat.orchestration.RustProService";
    impl<T> tonic::server::NamedService for RustProServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod backend_architect_service_server {
    ...
    #[async_trait]
    pub trait BackendArchitectService: std::marker::Send + std::marker::Sync + 'static {
        async fn analyze(
            &self,
    ...
    #[derive(Debug)]
    pub struct BackendArchitectServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> BackendArchitectServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for BackendArchitectServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "op_chat.orchestration.BackendArchitectService";
    impl<T> tonic::server::NamedService for BackendArchitectServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod workstack_service_server {
    ...
    #[async_trait]
    pub trait WorkstackService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct WorkstackServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> WorkstackServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for WorkstackServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "op_chat.orchestration.WorkstackService";
    impl<T> tonic::server::NamedService for WorkstackServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
