...
const AGENT_PORTS: &[(&str, u16)] = &[
    ("rust_pro", 50055),
    ("backend_architect", 50055),
    ("sequential_thinking", 50055),
    ("memory", 50055),
    ("context_manager", 50055),
    ("python_pro", 50055),
    ("debugger", 50055),
    ("mem0", 50055),
    ("search_specialist", 50055),
    ("deployment", 50055),
];
...
impl GrpcAgentPool {
    ...
    async fn do_connect(
        ...
        let channel = tonic::transport::Channel::from_shared(uri)
            ...
            .await
            .map_err(|e| {
                OrchestrationError::connection_failed(format!(
    ...
    async fn do_execute(
        ...
        let channel = {
            ...
            conn.channel
                .clone()
                .ok_or_else(|| OrchestrationError::connection_failed("Agent not connected"))?
        };
