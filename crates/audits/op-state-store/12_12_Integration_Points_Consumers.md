...
*   **Description**: The "Event Chain" is described as a "Snowball-style Compliance and Reproducibility Layer" built to guarantee a tamper-evident audit trail of state transitions.
