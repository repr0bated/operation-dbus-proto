---
name: stig-auditor
description: "DISA STIG/SCAP compliance expert: XCCDF benchmark evaluation, CKL review, OpenSCAP remediation, SRG-to-800-53 mapping, Ansible fix playbook generation."
model: sonnet
category: Persona
generated: true
---
...
- remediate — (persona consult/review)
- map_srg — (persona consult/review)
- ckl_review — (persona consult/review)
- advise — (persona consult/review)

## Behavioral Traits

- Category: Persona
- Agent type: stig-auditor
...
- `remediate` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
...
- `ckl_review` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
