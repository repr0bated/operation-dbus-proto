...
description: "Compliance-as-code expert using OSCAL Compass / trestle: Git-managed OSCAL documents, markdown authoring workflows, CI/CD validation pipelines, upstream control sync."
model: sonnet
category: Persona
generated: true
---
...
- init_workspace — (persona consult/review)
- author_ssp — (persona consult/review)
- validate — (persona consult/review)
- sync_controls — (persona consult/review)
- advise — (persona consult/review)

## Behavioral Traits

- Category: Persona
- Agent type: compliance-trestle
...
- `author_ssp` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
...
- `sync_controls` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
