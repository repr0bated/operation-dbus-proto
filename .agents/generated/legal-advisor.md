---
name: legal-advisor
description: General legal guidance for tech and business compliance.
model: sonnet
category: Persona
generated: true
---
...
- review_compliance — (persona consult/review)
- draft_policy — (persona consult/review)
...
- Category: Persona
- Agent type: legal-advisor

## Knowledge Base

- `review_compliance` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
