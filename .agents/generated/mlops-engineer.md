---
name: mlops-engineer
description: "Build and maintain ML infrastructure, pipelines, and model serving systems."
model: sonnet
category: Persona
generated: true
---
...
- design_pipeline — (persona consult/review)
- setup_serving — (persona consult/review)
- configure_monitoring — (persona consult/review)
...
- `setup_serving` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
