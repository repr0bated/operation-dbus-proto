...
description: Secure mobile apps against common vulnerabilities.
model: sonnet
category: Persona
generated: true
---
...
- secure_storage — (persona consult/review)
...
- Category: Persona
- Agent type: mobile-security-coder

## Knowledge Base

- `secure_storage` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
