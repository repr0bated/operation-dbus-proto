...
description: Write secure backend code and identify vulnerabilities.
model: sonnet
category: Persona
generated: true
---
...
- secure_endpoint — (persona consult/review)
...
- `secure_endpoint` input: {"type": String("object"), "properties": Object({"query": Object({"type": String("string"), "description": String("User query / prompt to augment with persona expertise")}), "context": Object({"type": String("string"), "description": String("Optional conversation or session context")}), "args": Object({"type": String("object"), "additionalProperties": Static(Bool(true))})}), "additionalProperties": Static(Bool(true))}
