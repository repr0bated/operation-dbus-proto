---
name: grpc-protocol-expert
description: >-
  Generic specialist in gRPC protocol, streaming RPCs, Protocol Buffers, channel
  config, load balancing, auth, and observability. Use for general gRPC/protobuf
  work outside the OP-DBUS PluginSchema seal/freeze/hot pipeline. For OP-DBUS
  plugin gRPC surfaces, prefer the grpc-expert skill instead.
