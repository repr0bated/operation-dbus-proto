...
echo "   UNIX_SOCKET_ENDPOINTS=mail-smtp:$SMTP_SOCKET:mail-smtp.ghostbridge.tech"
echo "   UNIX_SOCKET_ENDPOINTS+=,mail-imap:$IMAP_SOCKET:mail-imap.ghostbridge.tech"
echo "   UNIX_SOCKET_ENDPOINTS+=,mail-imaps:$IMAPS_SOCKET:mail-imaps.ghostbridge.tech"
echo ""
echo " Verify:"
